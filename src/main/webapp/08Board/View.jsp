...
<input type="hidden" name="num" value="<%= num %>">
    <table border="1" width="90%">
        ...
        <tr>
            ...
            <%
            /* 
            	로그인이 되었고, 세션영역에 저장된 아이디가 해당 게시물을 작성한 아이디와
            	일치한다면 수정, 삭제 버튼을 보이게 처리한다.
            	즉, 작성자 본인이 해당 게시물을 조회했을때 버튼이 보인다.
            */
            if(session.getAttribute("UserId") != null && session.getAttribute("UserId").toString().equals(dto.getId())) { //session영역에는 Object형태라서 toString으로 문자열로 반환한다.
            %>  
