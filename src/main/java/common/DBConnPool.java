...
DBCP(Database Connection Pool : 커넥션풀)
	...
	자원을 효울적으로 관리할 수 있다. 게임에서는 풀링시스템(Pooling System)
	이라는 용어로 사용한다.
*/
public class DBConnPool {
	...
	public DBConnPool() {
		try {
			...
			//4. 커넥션풀에 생성해 놓은 커넥션 객체를 가져다가 사용한다. (정보를 다 가지고 왔으니 연결한다.)
